...
export default function Layout({
  ...
  const sDesc = sBlockDesc.map((desc, i) => (
    <span key={i}>
      {desc}
      <br />
      <br />
  ...
  const tDesc = tBlockDesc.map((desc, i) => (
    <span key={i}>
      {desc}
      <br />
      <br />
  ...
  return (
    <>
      ...
      <div className="mainPart">
        ...
        <div className="mainPart-desc">{fBlockDesc}</div>
      ...
      <div className="secondBlock">
        <div className="secondBlock__wrapper">
          ...
          <div className="secondBlock__wrapper__text">
            ...
            <p className="secondBlock__wrapper__text-desc">
              <br />
              {sDesc}
            </p>
          </div>
