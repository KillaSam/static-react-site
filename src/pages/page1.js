...
const FirstPage = () => (
    ...
    <Layout fBlockTitle="PAGE1"
            ...
            sBlockDesc={['Morbi lacinia porttitor suscipit. Curabitur ultrices ante orci, vitae condimentum tellus hendrerit vitae. Nullam sollicitudin interdum nunc.',
            ...
            tBlockDesc={['There will be the next text block with image on right side and the background one']}
            />
  </section>
)
